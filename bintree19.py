...
# Results:
# Intel i3-4130T   Win8     41.98/21.83
# Intel i7-7700HQ  Debian9  25.64/ 8.10
# Ryzen 4500U      Win10    26.15/ 6.06
# Ryzen 3500U      Win11    34.70/10.62        
# Apple M1 (MBA)   macOS    19.55/ 4.50
# Apple M1 Pro     macOS
...
def main(m):
    ...
    print('stretch tree of depth {0}\t check: {1}'.format(stretch_depth, make_check(stretch_depth)))
